...
with col_p1:
    ...
    if media_fatturato > 0 or punto_pareggio_medio > 0:
        ...
        st.plotly_chart(fig_gauge, use_container_width=True, key="gauge_v52_final")
    else:
...
with col_p2:
    ...
    st.plotly_chart(fig_mag, use_container_width=True, key="mag_v52_final")
...
with col_p3:
    ...
    if 'scadenze_attive' in df_attivi.columns and (ultime_scadenze > 0 or ultime_rateizzazioni > 0):
        ...
        if not df_attivi.empty:
            ...
            st.plotly_chart(fig_line, use_container_width=True, key="line_v52_final")
